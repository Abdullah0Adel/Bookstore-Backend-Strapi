...
export interface ApiBookBook extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ASIN: Schema.Attribute.String;
    author: Schema.Attribute.String;
    bestSelling: Schema.Attribute.Boolean;
    book_format: Schema.Attribute.String;
    book_price: Schema.Attribute.Decimal;
    book_rating: Schema.Attribute.Decimal &
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::book.book'> &
      Schema.Attribute.Private;
    maxStok: Schema.Attribute.Integer;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    applied_promo_code: Schema.Attribute.String;
...
export interface ApiPromoCodePromoCode extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    range: Schema.Attribute.Decimal;
    range_desc: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customer_rating: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<5>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::review.review'
